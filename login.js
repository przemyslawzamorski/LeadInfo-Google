...
function log_in() {
    ...
    xhttp.open("GET", window.header + window.rest_url + "/rin/mob_leady?resultsPerPage=100&forceRefresh", true);
    console.log(window.header + window.rest_url + "/rin/mob_leady?resultsPerPage=100&forceRefresh");
